...
const useDistanceStore = createCalculatorStore<
	FormValues,
	DistanceResult | null
>({
				...
				<div className="space-y-4">
					...
					{distResult.midpoint && (
						<ResultGrid
							results={[
								{
									label: tMath("midpointX"),
									value: distResult.midpoint.x.toFixed(4),
								},
								{
									label: tMath("midpointY"),
									value: distResult.midpoint.y.toFixed(4),
								},
								...(distResult.midpoint.z !== undefined
									? [
											{
												label: tMath("midpointZ"),
												value: distResult.midpoint.z.toFixed(4),
											},
										]
									: []),
							]}
					...
					{distResult.bearing !== undefined && (
						<ResultGrid
							results={[
								{
									label: tMath("initialBearing"),
									value: distResult.bearing.toFixed(1),
									unit: "°",
								},
							]}
						/>
