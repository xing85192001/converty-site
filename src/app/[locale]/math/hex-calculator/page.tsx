...
const HexCalculator = dynamic(() => import("./hex-calculator").then((mod) => mod.HexCalculator), {
...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: ["hexadecimal", "hex", "decimal", "conversion", "RGB", "color", "calculator"],
  };
}

export default async function HexCalculatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
