...
const useLogarithmStore = createCalculatorStore<
	FormValues,
			...
			{logResult && (
				<div className="space-y-4">
					...
					<ResultGrid
						results={[
							{
								label: `${tMath("naturalLog")} (ln)`,
								value: logResult.naturalLog.toFixed(6),
							},
							{
								label: `${tMath("commonLog")} (log₁₀)`,
								value: logResult.log10.toFixed(6),
							},
							{ label: "log₂", value: logResult.log2.toFixed(6) },
							{
								label: tResults("antilog"),
								value: logResult.antilog.toFixed(6),
							},
						]}
					/>
