...
const useExponentStore = createCalculatorStore<
	FormValues,
	ExponentResult | null
>({
						...
						results={[
							{
								...
								value: expResult.scientificNotation,
							},
							...(expResult.reciprocal !== null
								? [
										{
											label: tResults("reciprocal"),
											value: expResult.reciprocal.toExponential(4),
										},
									]
								: []),
							...(expResult.logarithm !== null
								? [
										{
											label: `log_${values.base}(result)`,
											value: expResult.logarithm.toFixed(4),
										},
									]
								: []),
						]}
