...
const useRoundingStore = createCalculatorStore<
	FormValues,
	RoundingResult | null
>({
		...
		<div className="space-y-6">
			...
			{roundingResult && (
				<div className="space-y-4">
					...
					<ResultGrid
						results={[
							{ label: tResults("method"), value: roundingResult.method },
							{
								label: tResults("difference"),
								value: roundingResult.difference.toFixed(10),
							},
							{
								label: tResults("percentChange"),
