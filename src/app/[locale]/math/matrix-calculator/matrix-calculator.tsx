...
const modes: { value: Mode; labelKey: string; needsB: boolean }[] = [
	{ value: "add", labelKey: "matrixAddition", needsB: true },
	{ value: "subtract", labelKey: "matrixSubtraction", needsB: true },
	{ value: "multiply", labelKey: "matrixMultiplication", needsB: true },
	{ value: "transpose", labelKey: "matrixTranspose", needsB: false },
	{ value: "determinant", labelKey: "determinantDetA", needsB: false },
	{ value: "inverse", labelKey: "matrixInverse", needsB: false },
	{ value: "scalar", labelKey: "matrixScalar", needsB: false },
];
					...
					<Card>
						...
						<CardContent>
							<ResultGrid
								results={[
									{
										label: tResults("matrixADimensions"),
										value: result.dimensionsA,
									},
									...(result.dimensionsB
										? [
												{
													label: tResults("matrixBDimensions"),
													value: result.dimensionsB,
												},
											]
										: []),
									...(result.dimensionsResult
										? [
												{
													label: tResults("resultDimensions"),
													value: result.dimensionsResult,
												},
											]
										: []),
									{
										label: tResults("isSquareMatrix"),
										value: result.isSquare ? "Yes" : "No",
									},
									...(result.determinant !== undefined
										? [
												{
													label: tResults("determinant"),
													value: result.determinant.toFixed(6),
												},
											]
										: []),
									...(result.isInvertible !== undefined
										? [
												{
													label: tResults("invertible"),
													value: result.isInvertible ? "Yes" : "No",
												},
											]
										: []),
								]}
