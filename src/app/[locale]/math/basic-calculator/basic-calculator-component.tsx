...
const useBasicCalculatorStore = createCalculatorStore<
	FormValues,
...
export function BasicCalculatorComponent() {
	...
	const { values, setValue, result, calculationError } =
		useBasicCalculatorStore();
		...
		<div className="space-y-6">
			<div className="space-y-2">
				...
				<p className="text-xs text-muted-foreground">
					{tMath("supportedOperations")}: +, -, *, /, ^, %, sqrt, sin, cos, tan,
					log, ln, pi, e
				</p>
			</div>
			...
			<div className="space-y-2">
				...
				<RadioGroup
					...
					onValueChange={(v) =>
						setValue("angleMode", v as "degrees" | "radians")
					}
