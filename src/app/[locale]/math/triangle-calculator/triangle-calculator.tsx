...
const useTriangleStore = createCalculatorStore<
	FormValues,
	TriangleResult | null
>({
...
export function TriangleCalculator() {
	...
	const { values, setValue, result, errors, calculationError } =
		useTriangleStore();
				...
				<div className="space-y-2">
					...
					>
						...
						<SelectContent>
							...
							<SelectItem value="sasAngle">
								SAS (Two Sides + Included Angle)
							</SelectItem>
							<SelectItem value="asaAngles">
								ASA (Two Angles + Included Side)
							</SelectItem>
							<SelectItem value="aasAngles">
				...
				<div className="space-y-4">
					...
					<ResultGrid
						results={[
							...
							{
								label: tMath("angleA"),
								value: triangleResult.angleA.toFixed(2),
								unit: "°",
							},
							{
								label: tMath("angleB"),
								value: triangleResult.angleB.toFixed(2),
								unit: "°",
							},
							{
								label: tMath("angleC"),
								value: triangleResult.angleC.toFixed(2),
								unit: "°",
							},
						]}
					/>
					...
					<ResultGrid
						results={[
							{ label: tResults("type"), value: triangleResult.type },
							{ label: tResults("angleType"), value: triangleResult.angleType },
							{
								label: tResults("inradius"),
								value: triangleResult.inradius.toFixed(4),
							},
							{
								label: tResults("circumradius"),
