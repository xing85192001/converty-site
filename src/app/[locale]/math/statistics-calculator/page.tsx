...
const StatisticsCalculator = dynamic(
  () => import("./statistics-calculator").then((mod) => mod.StatisticsCalculator),
  {
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "converter.statistics-calculator" });
...
export default async function StatisticsCalculatorPage({
  ...
  const t = await getTranslations("converter.statistics-calculator");
