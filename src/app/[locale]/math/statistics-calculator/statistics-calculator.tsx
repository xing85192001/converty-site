			...
			<div className="space-y-4">
				<div className="space-y-2">
					...
					<p className="text-sm text-muted-foreground">
						{tMath("dataValuesHelp")}
					</p>
				</div>

				<div className="flex items-center justify-between">
					<div className="space-y-0.5">
						<Label htmlFor="population-switch">
							{tMath("populationOrSample")}
						</Label>
						<p className="text-sm text-muted-foreground">
							{isPopulation
								? tMath("populationVariance")
								: tMath("sampleVariance")}
						</p>
					</div>
					<Switch
				...
				<div className="space-y-4">
					...
					<ResultGrid
						results={[
							...
							{
								label: tMath("standardError"),
								value: result.standardError.toFixed(6),
							},
						]}
					/>
					...
					<div className="rounded-lg border p-4">
						...
						<ResultGrid
							results={[
								{
									label: tResults("q1"),
									value: result.quartiles.q1.toFixed(4),
								},
								{
									label: tResults("q2"),
									value: result.quartiles.q2.toFixed(4),
								},
								{
									label: tResults("q3"),
									value: result.quartiles.q3.toFixed(4),
								},
					...
					<ResultGrid
						results={[
							...
							...(result.geometricMean !== null
								? [
										{
											label: tMath("geometricMean"),
											value: result.geometricMean.toFixed(4),
										},
									]
								: []),
							...(result.harmonicMean !== null
								? [
										{
											label: tMath("harmonicMean"),
											value: result.harmonicMean.toFixed(4),
										},
									]
								: []),
						]}
