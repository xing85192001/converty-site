						...
						{result.ipVersion === 6 && (
							<div className="rounded-md bg-muted px-4 py-3">
								<p className="text-sm text-muted-foreground">
									...
									IPv6 has no broadcast address (uses multicast ff02::1) and no
									subnet mask notation (CIDR only).
								</p>
							</div>
						)}
						...
						{result.totalHosts > BigInt(Number.MAX_SAFE_INTEGER) && (
							<div className="rounded-md bg-muted px-4 py-3">
								<p className="text-sm text-muted-foreground">
									...
									Host counts exceed JavaScript&apos;s safe integer limit and
					...
					>
						<TabsList className="grid w-full grid-cols-3">
							...
							<TabsTrigger value="subnetting">
								{tAdvanced("mode-subnetting")}
							</TabsTrigger>
							<TabsTrigger value="supernetting">
								{tAdvanced("mode-supernetting")}
							</TabsTrigger>
						</TabsList>
