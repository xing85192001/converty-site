			...
			{result && (
				<div className="space-y-6">
					...
					<ResultGrid
						results={[
							{
								label: tResults("video"),
								value: Math.round(result.videoBytes / (1024 * 1024 * 1024)),
								unit: "GB",
							},
							{
								label: tResults("audio"),
								value:
									Math.round((result.audioBytes / (1024 * 1024 * 1024)) * 100) /
									100,
								unit: "GB",
							},
							{
								label: tResults("videoBitrate"),
								value: result.videoBitrate,
								unit: "Mbps",
							},
							{
								label: tResults("audioBitrate"),
								value: result.audioBitrate,
								unit: "kbps",
							},
						]}
						columns={2}
					...
					<div className="p-4 rounded-lg border bg-muted/50">
						...
						<ul className="text-sm text-muted-foreground space-y-1">
							<li>
								Video: JPEG2000 at {result.videoBitrate} Mbps (
