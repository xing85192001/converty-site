			...
			{result && (
				<div className="space-y-6">
					<ResultGrid
						results={[
							{
								label: tResults("diagonalFov"),
								value: result.fieldOfView,
								unit: "°",
							},
							{
								label: tResults("horizontalFov"),
								value: result.horizontalFOV,
								unit: "°",
							},
							{
								label: tResults("verticalFov"),
								value: result.verticalFOV,
								unit: "°",
							},
							{
								label: tResults("effectiveFocalLength"),
								value: result.effectiveFocalLength,
								unit: "mm",
							},
						]}
						columns={2}
