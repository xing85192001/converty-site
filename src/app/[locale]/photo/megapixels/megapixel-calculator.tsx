...
export function MegapixelCalculator() {
	...
	const calcResult = calculateMegapixels(
		parseInt(width) || 0,
		parseInt(height) || 0,
	);
				...
				<div className="space-y-6">
					...
					<ResultGrid
						results={[
							...
							{ label: tResults("aspectRatio"), value: result.aspectRatio },
							{ label: tResults("aspectDecimal"), value: result.aspectDecimal },
							{
								label: tResults("orientation"),
								value:
									result.orientation.charAt(0).toUpperCase() +
									result.orientation.slice(1),
							},
						]}
						columns={2}
					/>
