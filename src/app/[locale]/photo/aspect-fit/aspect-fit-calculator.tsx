...
import {
	COMMON_SCREENS,
	calculateAspectFit,
} from "@/lib/converters/photo/aspect-fit";
			...
			{result && (
				<div className="space-y-6">
					<ResultGrid
						results={[
							{
								label: tResults("fittedWidth"),
								value: result.fittedWidth,
								unit: "px",
							},
							{
								label: tResults("fittedHeight"),
								value: result.fittedHeight,
								unit: "px",
							},
							{ label: tResults("scaleFactor"), value: result.scale },
							{
								label: tResults("fill"),
					...
					<div className="flex justify-center p-4 border rounded-lg bg-muted/20">
						<div
							...
							style={{
								width: 200,
								height: 200 * (parseInt(screenHeight) / parseInt(screenWidth)),
							}}
						>
							<div
