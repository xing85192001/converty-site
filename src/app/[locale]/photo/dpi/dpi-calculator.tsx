			...
			{result && (
				<div className="space-y-6">
					...
					<ResultGrid
						results={[
							{
								label: tResults("pixelWidth"),
								value: result.pixelWidth,
								unit: "px",
							},
							{
								label: tResults("pixelHeight"),
								value: result.pixelHeight,
								unit: "px",
							},
							{
					...
					<div className="p-4 rounded-lg border bg-muted/50">
						...
						<p
							className={`text-xl font-semibold ${getQualityColor(result.printQuality)}`}
						>
							{result.printQuality}
						</p>
