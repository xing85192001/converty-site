...
export function PortraitDistanceCalculator() {
	...
	const [portraitType, setPortraitType] =
		useState<PortraitType>("head-shoulders");
			...
			{result && (
				<div className="space-y-6">
					...
					<ResultGrid
						results={[
							{
								label: tResults("minimumDistance"),
								value: result.minimumDistance,
								unit: "m",
							},
							{
								label: tResults("maximumDistance"),
								value: result.maximumDistance,
								unit: "m",
							},
							{
								label: tResults("fieldOfView"),
								value: result.fieldOfView,
								unit: "°",
							},
							{
								label: tResults("subjectHeight"),
								value: result.subjectHeight,
								unit: "m",
							},
						]}
						columns={2}
					...
					<div className="p-4 rounded-lg border bg-muted/50">
						...
						<p
							className={`text-xl font-semibold ${getCompressionColor(result.compressionEffect)}`}
						>
