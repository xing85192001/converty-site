...
const DiffractionCalculator = dynamic(
  () => import("./diffraction-calculator").then((mod) => mod.DiffractionCalculator),
  {
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "converter.diffraction" });
...
export default async function DiffractionPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations("converter.diffraction");
