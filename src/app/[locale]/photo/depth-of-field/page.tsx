...
const DepthOfFieldCalculator = dynamic(
  () => import("./depth-of-field-calculator").then((mod) => mod.DepthOfFieldCalculator),
  {
...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: ["depth of field", "dof", "photography", "aperture", "focal length"],
  };
}

export default async function DepthOfFieldPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
