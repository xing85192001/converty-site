...
} from "@/lib/converters/photo/depth-of-field";
			...
			{result && (
				<div className="space-y-6">
					<ResultGrid
						results={[
							{
								label: tResults("nearLimit"),
								value: formatDistance(result.nearLimit),
							},
							{
								label: tResults("farLimit"),
								value: formatDistance(result.farLimit),
							},
							{
								label: tResults("totalDoF"),
								value: formatDistance(result.totalDoF),
							},
							{
								label: tResults("hyperfocal"),
								value: `${result.hyperfocalDistance} m`,
							},
						]}
						columns={2}
					/>
