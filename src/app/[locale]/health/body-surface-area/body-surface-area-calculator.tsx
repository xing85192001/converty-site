			...
			{result && (
				<div className="space-y-4">
					<h3 className="text-lg font-semibold">
						{tResults("bodySurfaceArea")} ({tResults("multipleFormulas")})
					</h3>
					<ResultGrid
						results={[
							{
								label: tResults("duBoisFormula"),
								value: result.duBois,
								unit: "m²",
							},
							{
								label: tResults("mostellerFormula"),
								value: result.mosteller,
								unit: "m²",
							},
							{
								label: tResults("haycockFormula"),
								value: result.haycock,
								unit: "m²",
							},
							{
								label: tResults("gehanGeorgeFormula"),
								value: result.gehanGeorge,
								unit: "m²",
							},
							{
								label: tResults("boydFormula"),
								value: result.boyd,
								unit: "m²",
							},
							{
