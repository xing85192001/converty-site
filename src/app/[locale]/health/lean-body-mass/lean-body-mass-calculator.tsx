			...
			{result && (
				<div className="space-y-4">
					<h3 className="text-lg font-semibold">
						{tResults("leanMass")} ({tResults("multipleFormulas")})
					</h3>
					<ResultGrid
						results={[
							{
								label: tResults("boerFormula"),
								value: result.boerFormula.toFixed(1),
								unit: "kg",
							},
							{
								label: tResults("jamesFormula"),
								value: result.jamesFormula.toFixed(1),
								unit: "kg",
							},
							{
								label: tResults("humeFormula"),
							...
							{
								label: `tResults("bodyFatPercentageEstimated")`,
