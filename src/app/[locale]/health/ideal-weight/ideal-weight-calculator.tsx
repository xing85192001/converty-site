			...
			<div className="grid gap-4 sm:grid-cols-2">
				...
				<div className="space-y-2">
					...
					<Select
						...
						onValueChange={(v) =>
							setValue("frameSize", v as "small" | "medium" | "large")
						}
					>
						<SelectTrigger>
							<SelectValue />
			...
			{result && (
				<div className="space-y-4">
					<h3 className="text-lg font-semibold">
						{tResults("idealWeight")} ({tResults("multipleFormulas")})
					</h3>
					<ResultGrid
						results={[
							{
								label: tResults("robinsonFormula"),
								value: result.robinson.toFixed(1),
								unit: "kg",
							},
							{
								label: tResults("millerFormula"),
								value: result.miller.toFixed(1),
								unit: "kg",
							},
							{
								label: tResults("devineFormula"),
								value: result.devine.toFixed(1),
								unit: "kg",
							},
							{
								label: tResults("hamwiFormula"),
							...
							{
								label: tResults("rangeAdjustedFrame"),
