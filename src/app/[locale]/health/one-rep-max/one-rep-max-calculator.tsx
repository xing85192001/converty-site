			...
			{result && (
				<div className="space-y-4">
					...
					<h3 className="text-lg font-semibold">
						{tResults("formulaResults")}
					</h3>
					<ResultGrid
						results={[
							{
								label: tResults("epley"),
								value: Math.round(result.epley),
								unit: "kg",
							},
							{
								label: tResults("brzycki"),
								value: Math.round(result.brzycki),
								unit: "kg",
							},
							{
								label: tResults("lander"),
								value: Math.round(result.lander),
								unit: "kg",
							},
							{
								label: tResults("lombardi"),
								value: Math.round(result.lombardi),
								unit: "kg",
							},
							{
								label: tResults("mayhew"),
								value: Math.round(result.mayhew),
								unit: "kg",
							},
							{
								label: tResults("oConner"),
								value: Math.round(result.oconner),
								unit: "kg",
							},
							{
								label: tResults("wathan"),
								value: Math.round(result.wathan),
								unit: "kg",
							},
						]}
					/>
