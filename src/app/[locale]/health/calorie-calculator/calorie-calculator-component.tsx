			...
			<div className="grid gap-4 sm:grid-cols-2">
				...
				<div className="space-y-2">
					...
					<Select
						...
						onValueChange={(v) =>
							setValue("activityLevel", v as typeof values.activityLevel)
						}
					>
						<SelectTrigger>
							<SelectValue />
				...
				<div className="space-y-4">
					...
					{!result.isSafe && (
						<div className="rounded-md bg-destructive/10 p-3 text-destructive">
							Warning: This plan may not be safe. Consider extending your
							timeline or adjusting your goal.
						</div>
					)}
